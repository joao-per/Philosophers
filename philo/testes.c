...
t_philo	*init_philo(int ac, char **av)
{
	...
	//init_mutexes(philo, num_philo, 0);

	return(philo);
}

/* t_philo	*init_forks(t_philo *philo, int num_philo)
{
	int i;
...
void	init_mutexes(t_philo philo, int num_philo, int destroy)
{
	int i;
	t_info info;
	pthread_mutex_t *forks;
